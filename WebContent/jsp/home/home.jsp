...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="${ctxPath}/static/AmazeUI-2.4.2/assets/css/amazeui.css" rel="stylesheet" type="text/css" />
		<link href="${ctxPath}/static/AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css" />

		<link href="${ctxPath}/static/basic/css/demo.css" rel="stylesheet" type="text/css" />

		<link href="${ctxPath}/static/css/hmstyle.css" rel="stylesheet" type="text/css"/>
		<link href="${ctxPath}/static/css/skin.css" rel="stylesheet" type="text/css" />
		<script src="${ctxPath}/static/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
		<script src="${ctxPath}/static/AmazeUI-2.4.2/assets/js/amazeui.min.js"></script>
		
		<script type="text/javascript">
			$(function(){
				$("#myZone").click(function(){
					if(${empty user}){
						window.location="${ctxPath}/jsp/user/login.jsp"; 
					}else{
						window.location="${ctxPath}/jsp/person/index.jsp";
					}
				});
				...
				$("#mc-menu-hd").click(function(){
					if(${empty user}){
						...
						window.location="${ctxPath}/Shopgoods";
					}
				});
			});
		</script>
	...
	<body>
		<div class="hmtop">
			...
			<div class="am-container header">
					...
					<div class="topMessage">
						<div class="menu-hd">
							<c:if test="${empty sessionScope.user}">
								<a href="${ctxPath}/jsp/user/login.jsp?pageName=jsp/home/home.jsp" target="_top" class="h">亲，请登录</a>
								<a href="${ctxPath}/jsp/user/register.jsp?pageName=jsp/home/home.jsp" target="_top">免费注册</a>
							</c:if>
							<a>${sessionScope.user.nickName}</a>
						</div>
					</div>
				</ul>
				<ul class="message-r">
					...
					<div class="topMessage my-shangcheng">
						<div class="menu-hd MyShangcheng"><a id="myZone" href="#" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div>
					</div>
				...
				<div class="nav white">
					<div class="logo"><img src="${ctxPath}/static/images/logo.png" /></div>
					<div class="logoBig">
						<li><img src="${ctxPath}/static/images/logobig.png" /></li>
					</div>

					<div class="search-bar pr">
						<a name="index_none_header_sysc" href="#"></a>
						<form action="${ctxPath}/select">
			...
			<div class="banner">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<li class="banner1"><a href="introduction.html"><img src="${ctxPath}/static/images/ad1.jpg" /></a></li>
								<li class="banner2"><a><img src="${ctxPath}/static/images/ad2.jpg" /></a></li>
								<li class="banner3"><a><img src="${ctxPath}/static/images/ad3.jpg" /></a></li>
								<li class="banner4"><a><img src="${ctxPath}/static/images/ad4.jpg" /></a></li>
			...
			<div class="shopNav">
				<div class="slideall">
										...
										<ul class="category-list" id="js_climit_li">
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxPath}/static/images/cake.png"></i><a class="ml-22" title="点心">点心/蛋糕</a></h3>
													<em>&gt;</em></div>
															...
															<div class="menu-srot">
																<div class="sort-side">
																	<dl class="dl-sort">
																		...
																		<dd><a title="蒸蛋糕" href="${ctxPath}/Search?keyWord=蒸蛋糕"><span>蒸蛋糕</span></a></dd>
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxPath}/static/images/cookies.png"></i><a class="ml-22" title="饼干、膨化">饼干/膨化</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxPath}/static/images/meat.png"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxPath}/static/images/bamboo.png"></i><a class="ml-22" title="素食、卤味">素食/卤味</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxPath}/static/images/nut.png"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxPath}/static/images/candy.png"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxPath}/static/images/chocolate.png"></i><a class="ml-22" title="巧克力">巧克力</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxPath}/static/images/fish.png"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxPath}/static/images/tea.png"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative last">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxPath}/static/images/package.png"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
					...
					<div class="am-g am-g-fixed smallnav">
						<div class="am-u-sm-3">
							<a href="sort.html"><img src="${ctxPath}/static/images/navsmall.jpg" />
								<div class="title">商品分类</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="${ctxPath}/static/images/huismall.jpg" />
								<div class="title">大聚惠</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="${ctxPath}/static/images/mansmall.jpg" />
								<div class="title">个人中心</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="${ctxPath}/static/images/moneysmall.jpg" />
					...
					<div class="marqueen">
						...
						<div class="demo">
							...
							<ul>
								<li class="title-first"><a target="_blank" href="#">
									<img src="${ctxPath}/static/images/TJ2.jpg"></img>
									<span>[特惠]</span>商城爆品1分秒								
								</a></li>
								<li class="title-first"><a target="_blank" href="#">
									<span>[公告]</span>商城与广州市签署战略合作协议
								     <img src="${ctxPath}/static/images/TJ.jpg"></img>
								     <p>XXXXXXXXXXXXXXXXXX</p>
							    </a></li>
							    
						<div class="mod-vip">
							<div class="m-baseinfo">
								<a href="${ctxPath}/static/person/index.html">
									<img src="${ctxPath}/static/images/getAvatar.do.jpg">
								</a>
								<em>
                        ...
                        <div class="advTip"><img src="${ctxPath}/static/images/advTip.jpg"/></div>
						</div>
					</div>
					<div class="clear"></div>
				</div>
				...
				<div class="shopMain" id="shopmain">
					...
					<div class="am-g am-g-fixed recommendation">
						<div class="clock am-u-sm-3" ">
							<img src="${ctxPath}/static/images/2016.png "></img>
							<p>今日<br>推荐</p>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							...
							<div class="recommendationMain one">
								<a href="introduction.html"><img src="${ctxPath}/static/images/tj.png "></img></a>
							</div>
						</div>						
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain two">
								<img src="${ctxPath}/static/images/tj1.png "></img>
							</div>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain three">
								<img src="${ctxPath}/static/images/tj2.png "></img>
							</div>
						</div>
					  ...
					  <div class="am-g am-g-fixed ">
						<div class="am-u-sm-3 ">
							...
							<div class="activityMain ">
								<img src="${ctxPath}/static/images/activity1.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>														
						...
						<div class="am-u-sm-3 ">
						  <div class="icon-sale two "></div>	
							<h4>特惠</h4>
							<div class="activityMain ">
								<img src="${ctxPath}/static/images/activity2.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>								
							</div>							
						...
						<div class="am-u-sm-3 ">
							...
							<h4>团购</h4>
							<div class="activityMain ">
								<img src="${ctxPath}/static/images/activity3.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>							
						...
						<div class="am-u-sm-3 last ">
							...
							<h4>超值</h4>
							<div class="activityMain ">
								<img src="${ctxPath}/static/images/activity.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>													
					...
					<div class="am-g am-g-fixed floodFour">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							...
							<a href="# ">
								<div class="outer-con ">
                                  ...
                                  <img src="${ctxPath}/static/images/act1.png " />								
							</a>
							...
							<div class="am-u-sm-7 am-u-md-4 text-two sug">
								...
								<a href="# "><img src="${ctxPath}/static/images/2.jpg" /></a>
							</div>
							...
							<div class="am-u-sm-7 am-u-md-4 text-two">
								...
								<a href="# "><img src="${ctxPath}/static/images/1.jpg" /></a>
							</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three big">
							...
							<a href="# "><img src="${ctxPath}/static/images/5.jpg" /></a>
						</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three sug">
							...
							<a href="# "><img src="${ctxPath}/static/images/3.jpg" /></a>
						</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three ">
							...
							<a href="# "><img src="${ctxPath}/static/images/4.jpg" /></a>
						</div>
                 ...
                 <div class="clear "></div>  
					...
					<div class="am-g am-g-fixed floodThree ">
						...
						<div class="am-u-sm-4 text-four">
							<a href="# ">
								<img src="${ctxPath}/static/images/6.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>								
						...
						<div class="am-u-sm-4 text-four sug">
							<a href="# ">
								<img src="${ctxPath}/static/images/7.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>
						...
						<div class="am-u-sm-6 am-u-md-3 text-five big ">
							<a href="# ">
								<img src="${ctxPath}/static/images/10.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>		
						...
						<div class="am-u-sm-6 am-u-md-3 text-five ">
							<a href="# ">
								<img src="${ctxPath}/static/images/8.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>	
						...
						<div class="am-u-sm-6 am-u-md-3 text-five sug">
							<a href="# ">
								<img src="${ctxPath}/static/images/9.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>
		...
		<div class="navCir">
			...
			<li><a href="${ctxPath}/static/person/index.html"><i class="am-icon-user"></i>我的</a></li>					
		</div>
			...
			<div id="sidebar">
				<div id="wrap">
					<div id="prof" class="item ">
						...
						<div class="ibar_login_box status_login ">
							<div class="avatar_box ">
								<p class="avatar_imgbox "><img src="${ctxPath}/static/images/no-img_mid_.jpg " /></p>
								<ul class="user_info ">
									<li>用户名sl1903</li>
									<li>级&nbsp;别普通会员</li>
								</ul>
					...
					<div id="brand " class="item ">
						<a href="#">
							<span class="wdsc "><img src="${ctxPath}/static/images/wdsc.png " /></span>
						</a>
						<div class="mp_tooltip ">
							我的收藏
							<i class="icon_arrow_right_black "></i>
					...
					<div id="broadcast " class="item ">
						<a href="# ">
							<span class="chongzhi "><img src="${ctxPath}/static/images/chongzhi.png " /></span>
						</a>
						<div class="mp_tooltip ">
							我要充值
							<i class="icon_arrow_right_black "></i>
					...
					<div class="quick_toggle ">
						...
						<li class="qtitem ">
							...
							<div class="mp_qrcode " style="display:none; "><img src="${ctxPath}/static/images/weixin_code_145.png " /><i class="icon_arrow_white "></i></div>
						</li>
						<li class="qtitem ">
		...
		<script type="text/javascript " src="${ctxPath}/static/basic/js/quick_links.js "></script>
	</body>
